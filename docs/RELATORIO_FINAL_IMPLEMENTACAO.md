...
Storage local, PDF novo nao priorizado, endpoints academicos legados preservados, permissoes de colaborador ainda simplificadas e Docker nao foi executado neste ambiente porque o comando `docker` nao esta instalado.
